...
def test_invalid_isin_is_not_accepted_when_code_exists():
    document = load_fixture().replace(
        "BREXMPDBS001",
        "ISIN-INVALIDO",
    )
...
def test_definition_list_is_supported():
    document = """
    <html><body><dl>
        <dt>Codigo do Ativo</dt><dd>DLST12</dd>
        <dt>Emissor</dt><dd>Empresa Definition List</dd>
        <dt>Situacao</dt><dd>Vencida</dd>
    </dl></body></html>
    """
